...
public class UserCollectionRepositoryTests
{
    ...
    public async Task ListByUserAsync_WithTeamAndRarityFilter_ReturnsOnlyMatchingItemsAsync()
    {
        ...
        var repository = new UserCollectionRepository(dbContext);
        var filter = new ListCollectionModel { UserId = userId, TeamId = team1.Id, Rarity = StickerRarity.Foil, Page = 1, PageSize = 100 };
    ...
    public async Task ListByUserAsync_SortByUnknownValue_OrdersByCodeAsync()
    {
        ...
        var repository = new UserCollectionRepository(dbContext);
        var filter = new ListCollectionModel { UserId = userId, Sort = "invalid_sort_value", Page = 1, PageSize = 100 };
