...
public class MissingStickersQueryRequestValidator : AbstractValidator<MissingStickersQueryRequest>
{
    private static readonly string[] AllowedSortValues = ["number", "team", "rarity"];

    public MissingStickersQueryRequestValidator()
    {
        RuleFor(x => x.Page)
